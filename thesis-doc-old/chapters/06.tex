...
This chapter describes the testing methodology adopted to maintain the consistency and accuracy of the developed system. It covers the testing paradigm, the scope of test cases, a detailed analysis of encountered software defects, and the final experimental results.
...
\begin{itemize}
    ...
    \item \textbf{Confusion Matrix:} The normalized confusion matrix (Figure~\ref{fig:conf_matrix}) confirms the model's accuracy. The model correctly identified \textbf{98\%} of Cue Ball instances and \textbf{99\%} of Object Balls ("other"). Misclassifications (e.g., background detected as a ball) were negligible.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./graf/ball-detection/confusion_matrix_normalized.png}
    \caption{Normalized Confusion Matrix demonstrating high classification correctness between Cue Ball, Other, and Background.}
