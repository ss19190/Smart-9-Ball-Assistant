...
% TODO
% author:
\newcommand{\FirstNameAuthor}{Sara}
\newcommand{\SurnameAuthor}{Sobstyl}
\newcommand{\IdAuthor}{$\langle$306088$\rangle$}  % (remove $\langle$ and $\rangle)
...
\newcommand{\Supervisor}{$\langle$Dr. hab. inż. Jakub Nalepa$\rangle$}  % supervisor (remove $\langle$ and $\rangle)
\newcommand{\Title}{Smart 9-Ball Assistant}
\newcommand{\TitleAlt}{Inteligentny asystent do bilarda}
\newcommand{\Program}{Informatics}
\newcommand{\Specialisation}{$\langle$CGS$\rangle$} % your specialisation (remove $\langle$ and $\rangle)
\newcommand{\Departament}{$\langle$Katedra Algorytmiki i Oprogramowania$\rangle$} % your supervisor's departament (remove $\langle$ and $\rangle)
