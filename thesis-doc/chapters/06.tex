...
\noindent The status ``Partial'' for TC-04 means that the tracking algorithm can handle minor occlusions (e.g., when balls momentarily touch). However, during full occlusion --- for example when a ball is completely covered by the player's hand --- the tracking ID may occasionally reset. 
