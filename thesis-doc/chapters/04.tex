...
\begin{enumerate}
    ...
    \end{lstlisting}
    \textit{Note: The \texttt{gender} field accepts ``male" or ``female" (case-insensitive). This setting adjusts the arm mass coefficient used in the biomechanical calculations.}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item The system saves a snapshot of the stroke metrics, allowing the player to see if they maintained wrist steadiness during the shot.
\end{enumerate}
