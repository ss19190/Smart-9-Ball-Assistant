...
\newcommand{\IdAuthor}{306088}  % (remove $\langle$ and $\rangle)
...
\newcommand{\Supervisor}{Dr. hab. inż. Jakub Nalepa, prof. PŚ}  % supervisor (remove $\langle$ and $\rangle)
...
\newcommand{\Departament}{Katedra Algorytmiki i Oprogramowania} % your supervisor's departament (remove $\langle$ and $\rangle)
